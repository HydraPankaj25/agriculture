...
import subscriptionData from "../dataCenter/subscriptionData.json";
  ...
  return (
    <div className="px-4 sm:px-10 md:px-20 py-10">
      <h2 className="text-2xl sm:text-3xl font-semibold mb-5">
        <span className="text-[#39B54A]">Subscription </span>Products
      </h2>
      <div className="p-5 bg-linear-to-t from-[#FDDDEA] to-white">
        <Swiper
          loop={true}
          slidesPerView={1}
          spaceBetween={10}
